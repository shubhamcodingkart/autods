...
<div id="primary" class="home-content-area col-md-12">
    <div id="content" class="site-content" role="main">
        ...
        <div class="row">
            <div class="col-md-4">
                <?php 
                    if ( ! function_exists( 'Custom_Dokan_Category_Widget' ) ) :
                     ...
                     * @return void
                     */
                    function Custom_Dokan_Category_Widget() {
                            if ( class_exists( 'Custom_Dokan_Category_Widget' ) ) {
                                the_widget( 'Custom_Dokan_Category_Widget', array(
