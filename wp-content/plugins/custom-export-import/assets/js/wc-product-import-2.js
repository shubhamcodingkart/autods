...
;(function ( $, window ) {
	...
	var productImportForm = function( $form ) {
		this.$form           = $form;
		this.xhr             = false;
		this.mapping         = custom_wc_product_import_params.mapping;
		this.position        = 0;
		this.file            = custom_wc_product_import_params.file;
		this.update_existing = custom_wc_product_import_params.update_existing;
		this.delimiter       = custom_wc_product_import_params.delimiter;
		this.security        = custom_wc_product_import_params.import_nonce;
	...
	productImportForm.prototype.run_import = function() {
		...
		$.ajax( {
			...
			url: ajaxurl,
			data: {
				action          : 'woocommerce_do_ajax_product_import_custom',
