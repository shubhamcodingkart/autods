 ...
 */
if ( !class_exists( 'Custom_WC_Product_Importer', false ) ) {
 ...
 */
class Custom_WC_Product_CSV_Importer extends Custom_WC_Product_Importer {
    ...
    public function import() {
        ...
        foreach ( $this->parsed_data as $parsed_data_key => $parsed_data ) {
            ...
            if ( !$sku_exists) {
                $data['skipped'][] = new WP_Error( 'woocommerce_product_importer_error', __( 'No matching product exists to update.', 'dokan' ), array( 'sku' => $sku, 'row' => $this->get_row_id( $parsed_data ) ) );
                continue;
            }
