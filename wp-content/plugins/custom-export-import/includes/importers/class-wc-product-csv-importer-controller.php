 ...
 * @version     3.1.0
 */
class Custom_WC_Product_CSV_Importer_Controller {
    ...
    public static function get_importer( $file, $args = array() ) {
        //include_once( WP_PLUGIN_DIR. '/custom-export-import/includes/import/class-wc-product-csv-importer.php' );
        include_once(WP_PLUGIN_DIR.'/custom-export-import/includes/import/class-wc-product-csv-importer.php');
        //echo "string";
        $importer_class = apply_filters( 'woocommerce_product_csv_importer_class', 'Custom_WC_Product_CSV_Importer' );
    ...
    public function import() {
        ...
        wp_localize_script( 'custom-wc-product-import', 'custom_wc_product_import_params', array(
        ...
        wp_enqueue_script( 'custom-wc-product-import' );
    ...
    protected function auto_map_columns( $raw_headers, $num_indexes = true ) {
        ...
        $default_columns = apply_filters( 'woocommerce_csv_product_import_mapping_default_columns', array(
            ...
            __( 'Features', 'dokan' )                                => 'short_description',
    ...
    protected function get_mapping_options( $item = '' ) {
        ...
        $options        = array(
            ...
            'short_description'  => __( 'Features', 'dokan' ),
