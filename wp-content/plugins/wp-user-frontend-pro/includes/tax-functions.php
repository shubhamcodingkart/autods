    ...
    <table style="width:100%; table-layout:auto;" id="wpuf_tax_rates" class="wp-list-table widefat">
        ...
        <?php if( ! empty( $rates ) ) : ?>
            ...
            <tr>
                ...
                <td style="width:20%" class="wpuf_tax_rate"><input type="number" class="small-text" step="0.0001" min="0.0" max="99" name="wpuf_tax_rates[<?php echo $key; ?>][rate]" value="<?php echo esc_html( $rate['rate'] ); ?>"/></td>
