        ...
        $social_settings_fields = array(
            'wpuf_social_api' => array(
                ...
                'facebook_app_label'  => array(
                    ...
                    'type'  => "html",
                    'desc'  => '<a target="_blank" href="https://developers.facebook.com/apps/">' . __( 'Create an App', 'wpuf-social-api' ) . '</a> if you don\'t have one and fill App ID and App Secret below.',
                ),
                ...
                'twitter_app_label'   => array(
                    ...
                    'type'  => 'html',
                    'desc'  => '<a target="_blank" href="https://apps.twitter.com/">' . __( 'Create an App', 'wpuf-social-api' ) . '</a> if you don\'t have one and fill Consumer key and Consumer Secret below.',
                ),
                ...
                'google_app_label'    => array(
                    ...
                    'type'  => 'html',
                    'desc'  => '<a target="_blank" href="https://console.developers.google.com/project">' . __( 'Create an App', 'wpuf-social-api' ) . '</a> if you don\'t have one and fill Client ID and Client secret below. Also replace the {{form_id}} in Redirect URI with the registration form id where you are using Social Login.',
                ),
                'google_app_url'      => array(
                    'name'  => 'google_app_url',
                    'label' => __( 'Redirect URI', 'wpuf-social-api' ),
                    'type'  => 'html',
                    'desc'  => "<input class='regular-text' type='text' disabled value=" . $this->base_url . '?wpuf_reg=google&form_id={{form_id}}&hauth.done=Google' . '>',
                ),
                'google_app_id'       => array(
                    'name'  => 'google_app_id',
                ...
                'linkedin_app_label'  => array(
                    ...
                    'type'  => 'html',
                    'desc'  => '<a target="_blank" href="https://www.linkedin.com/developer/apps">' . __( 'Create an App', 'wpuf-social-api' ) . '</a> if you don\'t have one and fill Client ID and Client Secret below.',
                ),
