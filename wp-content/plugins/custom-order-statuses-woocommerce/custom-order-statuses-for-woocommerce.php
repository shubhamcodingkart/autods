...
Plugin URI: https://wpfactory.com/item/custom-order-status-woocommerce/
...
final class Alg_WC_Custom_Order_Statuses {
	...
	function action_links( $links ) {
		...
		if ( 'custom-order-statuses-for-woocommerce.php' === basename( __FILE__ ) ) {
			$custom_links[] = '<a href="https://wpfactory.com/item/custom-order-status-woocommerce/">' . __( 'Unlock All', 'custom-order-statuses-woocommerce' ) . '</a>';
		}
	...
	function includes() {
		...
		$this->settings = array();
		$this->settings['general'] = require_once( 'includes/admin/class-alg-wc-custom-order-statuses-settings-general.php' );
