...
if [[ "$1" == apache2* ]] || [ "$1" == php-fpm ]; then
	...
	# TODO handle WordPress upgrades magically in the same way, but only if wp-includes/version.php's $wp_version is less than /var/www/html/wp-includes/version.php's $wp_version
